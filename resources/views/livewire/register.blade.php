                ...
                <div class="card-body">
                    ...
                    <form wire:submit.prevent="register" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="input-group">
                            <input type="text" wire:model="name" autofocus autocomplete="additional-name"
                        ...
                        <div class="row mt-3">
                            <div class="col-8">
                                <div class="icheck-primary">
                                    <input wire:click="makeAgree" type="checkbox" id="agreeTerms" wire:model="terms"
                                        value="agree">
                            ...
                            <!-- /.col -->
                            <div class="col-4">
                                <button type="submit" @if (!$is_agree) disabled @endif
